...
function UserProfil() {
  return (
    <div className="profil flex flex-col gap-5 justify-center items-center px-32 custom:px-20 py-10 border border-gray-300 h-full rounded-lg">
      <img
        src={user}
        alt=""
        className="w-60 h-40 rounded-full border-4 border-white shadow-lg"
      />
      <p className="text-xl font-semibold custom:text-base ">Photo de profil</p>
